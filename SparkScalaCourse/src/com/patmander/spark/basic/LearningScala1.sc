object LearningScala1 {
  ...
  val hello: String = "Boom!"                     //> hello  : String = Boom!
  println(hello)                                  //> Boom!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Boom!
  helloThere = hello + " There!"
  println(helloThere)                             //> Boom! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Boom!There!
  println(immutableHelloThere)                    //> Boom!There!
  ...
  val theUltimateAnswer: String = "To life, the universe, and everything is 42 and 100."
                                                  //> theUltimateAnswer  : String = To life, the universe, and everything is 42 a
                                                  //| nd 100.
  val pattern = """.*?the(.*?) (\d+).*?(\d+).*""".r
                                                  //> pattern  : scala.util.matching.Regex = .*?the(.*?) (\d+).*?(\d+).*
  val pattern(afterThe, answerString, answerString2) = theUltimateAnswer
                                                  //> afterThe  : String = " universe, and everything is"
                                                  //| answerString  : String = 42
                                                  //| answerString2  : String = 100
  ...
  println(f"Exercise answer:  ${piSinglePrecision*2}%.3f")
                                                  //> Exercise answer:  6.283
